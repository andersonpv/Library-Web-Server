...
{
    public partial class Team56LibraryContext : DbContext
    {
        public Team56LibraryContext()
        {
        }

        public Team56LibraryContext(DbContextOptions<Team56LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u0831946;Password=zxcvbnm;Database=Team56Library");
            }
        }
